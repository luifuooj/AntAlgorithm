...
<main role="main" class="container mt-5">
    ...
    <div class="row justify-content-md-center">
        <div class="col-sm-4 card m-2 px-0">
            ...
            <form class="card-body" action="/query" method="post" onsubmit="new MyCustomFunction()">
                <fieldset>
                    <div class="form-group row mb-2 justify-content-between">
                        <div class="col-4"><label for="fullOrder">Количество</label></div>
                        <div class="col-8"><input required class="form-control" type="number" name="fullOrder" id="fullOrder"></div>
                    </div>
                    <div class="form-group row mb-2 justify-content-between">
                    ...
                    <div class="form-group row justify-content-center">
                        <div class="col">
                            <button type="submit" class="btn btn-outline-primary" id="load"
                                    data-loading-text="Выполняется..." value="query">Рассчитать
                            </button>
                        </div>
                    </div>
                </fieldset>
...
<footer class="footer mt-5 py-4 bg-light">
    <div class="container">
            <span class="text-muted">Выпускная квалификационная работа Попеляевой О.С. Краснодар 2021г.
            <br> Модель определения предпочтительных условий коммерческой закупки продукции при наличии ограничений со
            стороны Поставщика и Компании</span>
    </div>
</footer>
