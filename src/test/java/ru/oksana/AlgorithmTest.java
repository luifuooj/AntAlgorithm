...
class AlgorithmTest {
    ...
    void setUp() {
        ...
        addSupplier("Supplier #2", "Огурцы, кг", 500., 40., 20, 5, 4000.);
        addSupplier("Supplier #3", "Огурцы, кг", 800., 45., 25, 4, 5000.);
    ...
    @Test
    void alg() {
        Algorithm algorithm = new Algorithm(10000., 10000L, 5000L, supplierList, 0.5, -0.2);
        algorithm.calculate();
